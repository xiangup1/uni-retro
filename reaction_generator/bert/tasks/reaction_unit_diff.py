...
from ..data import Dictionary, FixPadDataset, KeyDataset
...
@register_task("reaction_unit_diff")
class ReactionUnitDiffTask(UnicoreTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        def one_dataset(raw_dataset, coord_seed, mask_seed):
            ...
            rec_size_dataset = KeyDataset(raw_dataset, 'rec_size')   
            tar_size_dataset = KeyDataset(raw_dataset, 'tar_size')  
            ...
            tgt_dataset = PrependAndAppend(tgt_dataset, self.dictionary.bos(), self.dictionary.eos())
            ...
            pad_reverse_tgt_dataset = FixPadDataset(reverse_tgt_dataset, pad_idx=self.dictionary.pad())
            ...
            return {
                ...
                "rec_size": RawLabelDataset(rec_size_dataset),
                "tar_size": RawLabelDataset(tar_size_dataset),
            }, {
