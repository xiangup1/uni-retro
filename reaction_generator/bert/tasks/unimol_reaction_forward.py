...
@register_task("unimol_reaction_forward")
class UniMolReactionForwardTask(UnicoreTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        def one_dataset(raw_dataset, coord_seed, mask_seed):
            ...
            self.src_sizes, self.tgt_sizes = SizeDataset(raw_dataset, 'smiles_train', 'smiles_target').get_size_data()
            ...
            if self.use_selfies == 0:
                ...
                token_dataset = KeyDataset(raw_dataset, 'selfies_train')
                token_target_dataset = KeyDataset(raw_dataset, 'selfies_target')
            ...
            decoder_target = PrependAndAppend(token_target_dataset, self.dictionary.bos(), self.dictionary.eos())       
