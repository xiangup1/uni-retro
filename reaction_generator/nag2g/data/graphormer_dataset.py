import pandas as pd
from ..utils.graph_process import graph2seq_process
from ..utils.smiles2feature import process_one
...
debug = False
if debug:
    from ..utils.graph_process import get_seq_from_mol
    from ..utils.smiles_mol_trans import (
    ...
    from ..utils.seq2smi import seq2info
