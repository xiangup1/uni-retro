...
def draw_mol(mol):
    FIG_PATH = '/data/users/qifanyu/nag2g_ReRP/ReRP/outputs/figs/'
...
if __name__ == "__main__":
    ...
    if MODE == 'retrosynthesis':
        ...
        # 出现在断键位置(53)
        # 原料中不包含信息(55)
        json_filename = '/data/users/qifanyu/nag2g_ReRP/ReRP/outputs/weights/synthesis/2023-07-08/ReRP_G2GT_uspto_50k_b16_1_l6_vnode1_wda_true_lp_0_0_nsum2_false_sep2_false_cls_false_hdegree_true_sg_randomsmiles_lr_2.5e-4_wd_0.0_mp__20230708-075111/checkpoint_last/strict_failed_samples.json'
        json_filename = '/data/users/yaolin/ReRP/outputs/weights_20230717/ReRP_G2GT_uspto_50k_b16_1_l6_vnode1_wda_true_lp_0_0_nsum2_false_sep2_false_cls_false_hdegree_true_sg_randomsmiles_lr_2.5e-4_wd_0.0_mp__20230717-154639/checkpoint_last/strict_failed_samples.json'
