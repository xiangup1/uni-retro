...
def check_all():
    ...
    p = "/data/fs_users/yaolin/ReRP_dataset/dataset/ReRP_/pistachio/pistachio_clean_dataset_s_filter_all/test.csv"
    # p = "/data/fs_projects/ReRP/dataset/ReRP_/USPTO50K_raw_20230220/test.csv"
    # p = "/data/fs_projects/ReRP/dataset/synthesis/uspto_full_bek2/test.csv"
    df = pd.read_csv(p)
