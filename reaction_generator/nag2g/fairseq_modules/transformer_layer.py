...
from ..utils import utils as RerpUtils
from ..fairseq_modules import TransformerConfig
from ..fairseq_modules import LayerNorm, MultiheadAttention
from ..fairseq_modules.fairseq_dropout import FairseqDropout
from ..fairseq_modules.quant_noise import quant_noise
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.attn_ln = (
            ...
            if RerpUtils.safe_getattr(cfg, "scale_attn", False)
            else None
        )
        self.nh = self.self_attn.num_heads
        self.head_dim = self.self_attn.head_dim
        scale_heads = RerpUtils.safe_getattr(cfg, "scale_heads", False)
        self.c_attn = (
        ...
        self.ffn_layernorm = (
            ...
            if RerpUtils.safe_getattr(cfg, "scale_fc", False)
            else None
        )
        self.w_resid = (
            nn.Parameter(
            ...
            if RerpUtils.safe_getattr(cfg, "scale_resids", False)
            else None
        )
