...
class TransformerMEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn_sandwich_layer_norm = (
            LayerNorm(self.embedding_dim, export=export) if self.sandwich_ln else None
        )
        ...
        self.final_sandwich_layer_norm = (
            LayerNorm(self.embedding_dim) if self.sandwich_ln else None
        )
